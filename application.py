...
#  o    mpare faces
        id_ = name[0]['id']
        image_1 = find_face_encodings("./static/face/unknown/" + str(id_) + ".jpg")
        image_2 = find_face_encodings("./static/face/" + str(id_) + ".jpg")
    ...
    # Handle the case where no faces are found, for example, redirect to an error page or show an appropriate message
            return render_template("error.html", message="No faces found in the images.")
...
def find_face_encodings(image_path):
    ...
    if not face_enc:
        # handle the case where no faces are found, you might want to return an error code or raise an exception
        return None
